chcp 65001
ECHO OFF
ECHO Арифметический алгоритм сжатия
ECHO Внимание!! Этот алгоритм работает очень долго на больших тестах (500+ букв уже ощутимо медленно)
...
set /P probs="> ":
call mvn -e exec:java -Dexec.mainClass=ru.itis.algorithms.classes.launchers.MainArithmetic -Dexec.args="%in% %encoded% %decoded% %probs%"
PAUSE